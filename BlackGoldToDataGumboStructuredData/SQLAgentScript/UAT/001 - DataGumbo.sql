...
EXEC msdb.dbo.sp_add_jobstep @job_name = @jobName, @step_name = N'1', @step_id = 1, @subsystem = N'SSIS', @command = N'/FILE "\"\\cal0-vu-asis01\SSIS\DataGumbo\Package.dtsx\"" /CHECKPOINTING OFF /SET "\"\Package.Variables[User::intHoursBack].Properties[Value]\"";1 /SET "\"\Package.Variables[User::strAccessKey].Properties[Value]\"";"\"testAccessKey_ummagumma68Fuchsia\"" /SET "\"\Package.Variables[User::strApiKey].Properties[Value]\"";"\"testApiKey_2112$pentagonalDarkness\"" /SET "\"\Package.Variables[User::strBGConnectionString].Properties[Value]\"";"\"Data Source=CAL0-PP-SQC1V10\PROD10;User ID=_blackGoldRead;Password=BUuXFUaB5H;Initial Catalog=Blackgold_PROD;Provider=SQLNCLI11.1;Auto Translate=False;\"" /SET "\"\Package.Variables[User::strServerName].Properties[Value]\"";"\"ensign-api.azurewebsites.net\"" /SET "\"\Package.Variables[User::strLogFilePath].Properties[Value]\"";"\"\\CAL0-VU-ASIS01\SSIS\DataGumbo\Logs\"" /SET "\"\Package.Variables[User::strEnv].Properties[Value]\"";UAT /REPORTING E'
-- Hourly
EXEC msdb.dbo.sp_add_jobschedule @job_name = @jobName, @name=N'Every 15 minutes', 
		...
		@active_start_time=000500, @active_end_time=235959
